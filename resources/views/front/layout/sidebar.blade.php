 <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item {{Route::is('attendee_ticket') ? 'active-item': ''}}"><a href="{{route('attendee_ticket')}}">My Tickets</a></li>
    <li class="list-group-item {{Route::is('attendee_message') ? 'active-item': ''}}"><a href="{{route('attendee_message')}}">Messages</a></li>
